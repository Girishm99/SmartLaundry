...
<head>
  ...
  <title>SMART LAUNDRY | Delivered Orders</title>
          ...
          <!--Cloth category-->
           ...
           <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview" style="padding-left: 10px;">
              ...
              <li class="nav-item">
                  <a href="addcloth_category.jsp" class="nav-link">
                      <img src="../images/addcustomer.png" class="nav-icon" alt=""/>
                  <p>Add Customer</p>
                </a>
              </li>
          ...
          <!--Customer-->
           ...
           <li class="nav-item has-treeview" >
            ...
            <ul class="nav nav-treeview" style="padding-left: 10px;">
              ...
              <li class="nav-item">
                  <a href="addorder.jsp" class="nav-link">
                  <img src="../images/medical-report.png" class="nav-icon" alt=""/>
                  <p>Add Order</p>
                </a>
              </li>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body" style="background-color:">
                <a href="deliverdorders.jsp" class=" btn btn-primary" role="button">Deliverd Orders</a>
                <a href="confirmedorders.jsp" class=" btn btn-primary" role="button">Confirmed Orders</a>
                <br><br>
