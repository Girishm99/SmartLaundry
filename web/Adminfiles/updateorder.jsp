...
<head>
  ...
  <title>SMART LAUNDRY | Update Order</title>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
             ...
             <form action="../updateorder_status" method="post">
                     <%
             ...
             %>
              <table id="example2" class="table table-bordered table-hover">
                <tr>
                    ...
                    <td><input type="text" required name="order_status" value="" class="form-control"></td>
                </tr>
                 <input type="text"  hidden name="order_id"  value='<%=order_id%>' class="form-control">
