...
<head>
  ...
  <title>SMART LAUNDRY | Edit Cloth</title>
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
                <%@page import="com.org.model.Clothdetail,java.util.*" %>
               <form action="../UpdateCloth" method="post">
                 ...
                 Clothdetail c1=c.getOneclothdetail(cloth_id);
             %>
              <table id="example2" class="table table-bordered table-hover">
                <tr>
                    <td>Edit Cloth </td>
                    <td><input type="text" required name="cloth_name" value="<%=c1.getCloth_name()%>" class="form-control"></td>
                </tr>
                <tr>
                <td>Edit Cloth Rate </td>
                    <td><input type="text" required name="iron_rate" value="<%=c1.getIron_rate()%>" class="form-control"></td>
                </tr>
                <tr>
                    <td><input type="text" hidden  name="cc_id"  class="form-control"></td>
                </tr>
              <tr>
                    <td><input type="text" hidden  name="cloth_id"  value='<%=request.getParameter("cloth_id")%>' class="form-control"></td>
                </tr>
                <tr>
