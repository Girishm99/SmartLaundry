...
<head>
  ...
  <title>SMART LAUNDRY | All Cloth Category</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Cloth category</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <%@page import="com.org.model.Clothcategory,java.util.*" %>
                ...
                while(it.hasNext()){
                    ...
                    <tr style="text-align:center;">
                        ...
                        <td><%=c1.getCc_id()%></td>
                        <td><%=c1.getCc_name()%></td>
                        <td><a href="editcategory.jsp?cc_id=<%=c1.getCc_id()%>"><i class="fas fa-edit"></i>Edit</a></td>
                        <td><a href="deletecategory.jsp?cc_id=<%=c1.getCc_id()%>"><i class="fas fa-trash-alt"></i>Delete</a></td>
