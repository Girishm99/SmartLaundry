...
<head>
  ...
  <title>SMART LAUNDRY | Add Cloth Category</title>
            ...
            <div class="card-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
                <tr>
                    ...
                    <td><input type="text" required name="cc_name" class="form-control"></td>
                </tr>
                 <tr>
                    <td>Laundry Price</td>
                    <td><input type="text" required name="laundry_price" class="form-control"></td>
                </tr>
                 <tr>
                    <td>Iron Rate</td>
                    <td><input type="text" required name="iron_rate" class="form-control"></td>
                </tr>
                
                <tr>
                    <td colspan="2"><button type="suibmit" class="btn btn-primary" >ADD</button></td>
                </tr>
            </table>
        </form>
