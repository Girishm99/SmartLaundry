...
<head>
  ...
  <title>SMART LAUNDRY | All Cloths</title>
          ...
          <div class="card">
            <div class="card-body" style="background-color:">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <%@page import="com.org.model.Clothdetail, com.org.model.Clothcategory;,java.util.*" %>
                ...
                while(it.hasNext()){
                    ...
                    <tr style="text-align:center;">
                        <td><%=s%></td>
                        <td><%=c1.getCc_id()%></td>
                        <td><%=c1.getCloth_id()%></td>
                        <td><%=c1.getCloth_name()%></td>
                        
                        <td><a href="editcloth.jsp?cloth_id=<%=c1.getCloth_id()%>"><i class="fas fa-edit"></i>Edit</a></td>
                        <td><a href="deletecloth.jsp?cloth_id=<%=c1.getCloth_id()%>"><i class="fas fa-trash-alt"></i>Delete</a></td>
