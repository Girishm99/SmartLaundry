...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Smart Laundry || Admin Login page</title>
                    ...
                    <div class="signin-form">
                        ...
                        <form  method="post" action="AdminLogin">
                            <div class="form-group">
                                ...
                                <input type="email" name="admin_email"  placeholder="ex: abc@gmail.com"/>
                            </div>
                            <div class="form-group">
        ...
        <footer >
         <div class="footer">
                    ...
                    <div style="padding-left: 43%;">
                        ...
                        Designed by <a href="admin_login.jsp">GIRISH MUSHAM</a>
                    </div>
                </div>
            </footer><!-- #footer -->
