...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Smart Laundry || Forgot Password</title>
                        ...
                        <h2 class="form-title">Forgot Password</h2>
                         <form action="forgotpassword.jsp" method="post">
                            <div class="form-group">
                                ...
                                <input type="email" name="email"  placeholder="ex: abc@gmail.com" required/>
                            </div>
                            <div class="form-group">
                                <label><i class="zmdi zmdi-lock"></i></label>
                                <input type="text" name="number"  placeholder="mobiole number" required/>
                            </div>
...
<%
        String Cemail=request.getParameter("email");
            ...
            String sql= "select cust_password from cust_detail where cust_email='"+Cemail +"' AND cust_contact='"+Mnumber +"' ";
              ...
              String Body="Your Email ID is "+ Cemail +" Password for Smart Laundry Account is "+Password +"";
